    ...
    <div className="flex flex-wrap gap-2 px-4 py-2.5 bg-card/80 backdrop-blur border-b border-border shrink-0">
      ...
      <div className="flex gap-2 flex-1 flex-wrap sm:flex-nowrap items-center min-w-0">
        ...
        <select
          ...
          className="flex-1 sm:flex-none min-w-0 bg-muted text-foreground text-sm px-3 py-1.5 rounded-md border border-border focus:outline-none focus:border-ring cursor-pointer"
        >
        ...
        <div className="relative flex-1 sm:w-48 sm:flex-none min-w-0">
          <input
            ...
            className="w-full bg-muted text-foreground text-sm px-3 py-1.5 rounded-md border border-border focus:outline-none focus:border-ring placeholder:text-muted-foreground"
          />
          {filterSkill && (
            <button
