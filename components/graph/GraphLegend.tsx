...
export default function GraphLegend({ activeGroup, onGroupClick }: GraphLegendProps) {
  return (
    <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 px-4 py-2 bg-gray-900/80 border-t border-gray-700/60 flex-shrink-0 overflow-x-auto">
      ...
      <span className="ml-auto text-xs text-gray-500 whitespace-nowrap hidden sm:inline">
